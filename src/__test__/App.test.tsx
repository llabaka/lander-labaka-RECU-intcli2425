...
import { calculateTotalGuardsByWeapon, countDefendersByTower, countOtherResources, countRecurses, countRoles, countTowersByHeight, countVillagersByProfession, findTowerWithMostGuards, getGuardsByRank, getTowersAndGuardsByWeaponType, obtainAllWeapons, obtainProfessionWithMostInhabitants, obtainTowerByGuards, obtainTowerByMinAmmo, obtainTowerByMinHeight, obtainTowerByMostArmament, showNearestLandMarks, totalGuards, totalMunitionByWeapon, weaponCount } from '../helpers/helpers';
