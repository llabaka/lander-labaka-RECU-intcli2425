...
import { calculateTotalGuardsByWeapon, countDefendersByTower, countOtherResources, countRecurses, countRoles, countTowersByHeight, countVillagersByProfession, filterEventsByOutcome, findTowerWithMostGuards, getGuardsByRank, getTowersAndGuardsByWeaponType, guardsOfSameName, obtainAllWeapons, obtainProfessionWithMostInhabitants, obtainTowerByGuards, obtainTowerByMinAmmo, obtainTowerByMinHeight, obtainTowerByMostArmament, showNearestLandMarks, totalGuards, totalMunitionByWeapon, weaponCount } from '../helpers/helpers';
...
describe('Recibe la fortaleza. Devuelve las profesionales y la cantidad de profesionales de los pueblerinos', () => {
  it('Devuelve tipo Record <nombre, cantidad>', () => {
    ...
    const filtered = filterEventsByOutcome(fortress, 'Partial Destruction');
